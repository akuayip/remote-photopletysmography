...
class AppRPPG(tk.Tk):
    ...
    def create_widgets(self):
        ...
        numeric_data_area = ttk.LabelFrame(right_column_frame, text=" Data Terukur ") 
        numeric_data_area.grid(row=1, column=0, sticky="nsew", padx=5, pady=(5,0)) 
        ...
        lbl_rr_title = tk.Label(numeric_data_area, text="RR", font=("Arial", 12, "bold"), fg="green")
        lbl_rr_title.grid(row=0, column=0, sticky="s", pady=(5,0))
        self.lbl_rr_value = tk.Label(numeric_data_area, text="--", font=("Arial", 36, "bold"), fg="green")
        self.lbl_rr_value.grid(row=1, column=0, sticky="nsew")
        lbl_rr_unit = tk.Label(numeric_data_area, text="rpm", font=("Arial", 10), fg="green")
        lbl_rr_unit.grid(row=2, column=0, sticky="n", pady=(0,5)) 

        lbl_hr_title = tk.Label(numeric_data_area, text="rPPG", font=("Arial", 12, "bold"), fg="red")
        lbl_hr_title.grid(row=0, column=1, sticky="s", pady=(5,0))
        self.lbl_hr_value = tk.Label(numeric_data_area, text="--", font=("Arial", 36, "bold"), fg="red")
        self.lbl_hr_value.grid(row=1, column=1, sticky="nsew")
        lbl_hr_unit = tk.Label(numeric_data_area, text="bpm", font=("Arial", 10), fg="red")
        lbl_hr_unit.grid(row=2, column=1, sticky="n", pady=(0,5))
